...
}`,..._.parameters?.docs?.source},description:{story:"Every variant × size × state at a glance",..._.parameters?.docs?.description}}};const xe=["Default","Primary","Secondary","TextBlue","TextGrey","SizeLarge","SizeMedium","SizeSmall","AllSizes","Disabled","DisabledSecondary","DisabledText","WithLeftIcon","WithRightIcon","WithBothIcons","IconOnly","LongText","ShortText","InsideForm","TokenUsage","AllVariants"];export{S as AllSizes,_ as AllVariants,u as Default,I as Disabled,z as DisabledSecondary,T as DisabledText,w as IconOnly,C as InsideForm,D as LongText,g as Primary,x as Secondary,L as ShortText,h as SizeLarge,b as SizeMedium,v as SizeSmall,y as TextBlue,f as TextGrey,R as TokenUsage,k as WithBothIcons,B as WithLeftIcon,j as WithRightIcon,xe as __namedExportsOrder,ge as default};
