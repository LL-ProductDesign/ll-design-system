...
When false (default), tabs size to their content.`,defaultValue:{value:"false",computed:!1}}}};const R={title:"Design System/UnderlineTabs",component:y,parameters:{layout:"padded",docs:{description:{component:"Tabs allow users to navigate between related views of content while remaining in context of the page."}}},argTypes:{stretched:{control:"boolean"},activeId:{control:"text"}}};function i({tabs:n,stretched:t}){const[l,o]=S.useState(n[0].id);return e.jsx("div",{style:{width:t?480:void 0},children:e.jsx(y,{tabs:n,activeId:l,onChange:o,stretched:t})})}const j=[{id:"tab1",label:"Tab 1"},{id:"tab2",label:"Tab 2"},{id:"tab3",label:"Tab 3"}],c={render:()=>e.jsx(i,{tabs:j})},b={render:()=>e.jsx(i,{tabs:j,stretched:!0})},u={render:()=>e.jsx(i,{tabs:[{id:"all",label:"All"},{id:"unread",label:"Unread",counter:12},{id:"today",label:"Today",counter:3}]})},h={render:()=>e.jsx(i,{tabs:[{id:"tab1",label:"Active"},{id:"tab2",label:"Resting"},{id:"tab3",label:"Disabled",disabled:!0}]})},s=()=>e.jsxs("svg",{viewBox:"0 0 20 20",fill:"currentColor",style:{width:"100%",height:"100%"},children:[e.jsx("rect",{x:"3",y:"3",width:"14",height:"14",rx:"3",opacity:"0.4"}),e.jsx("circle",{cx:"10",cy:"10",r:"3"})]}),p={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:32},children:[e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"'Fira Sans', sans-serif",fontSize:12,marginBottom:8,color:"#5d7682"},children:"Left icon"}),e.jsx(i,{tabs:[{id:"a",label:"Overview",icon:e.jsx(s,{}),iconPosition:"left"},{id:"b",label:"Details",icon:e.jsx(s,{}),iconPosition:"left"},{id:"c",label:"History",icon:e.jsx(s,{}),iconPosition:"left"}]})]}),e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"'Fira Sans', sans-serif",fontSize:12,marginBottom:8,color:"#5d7682"},children:"Right icon"}),e.jsx(i,{tabs:[{id:"a",label:"Overview",icon:e.jsx(s,{}),iconPosition:"right"},{id:"b",label:"Details",icon:e.jsx(s,{}),iconPosition:"right"},{id:"c",label:"History",disabled:!0,icon:e.jsx(s,{}),iconPosition:"right"}]})]})]})},f={name:"All states (reference)",render:()=>{const n=[{id:"resting",label:"Resting"},{id:"selected",label:"Selected"},{id:"hover",label:"Hover (mouse over)"},{id:"disabled",label:"Disabled",disabled:!0}];return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:24,fontFamily:"'Fira Sans', sans-serif"},children:[e.jsx(i,{tabs:n}),e.jsx(i,{tabs:[{id:"all",label:"All"},{id:"unread",label:"Unread",counter:5},{id:"today",label:"Today"}]})]})}},m={name:"Notifications panel usage",render:()=>e.jsx(i,{tabs:[{id:"all",label:"All"},{id:"unread",label:"Unread"},{id:"today",label:"Today"}]})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source}}};const W=["Default","Stretched","WithCounter","WithDisabled","WithIcons","AllStates","NotificationsExample"];export{f as AllStates,c as Default,m as NotificationsExample,b as Stretched,u as WithCounter,h as WithDisabled,p as WithIcons,W as __namedExportsOrder,R as default};
