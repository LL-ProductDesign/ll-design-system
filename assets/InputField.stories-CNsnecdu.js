...
}`,...g.parameters?.docs?.source},description:{story:"Resting state — no interaction",...g.parameters?.docs?.description}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Level',
    required: true,
    placeholder: 'All levels',
...
}`,...b.parameters?.docs?.source},description:{story:"Hover — subtle background darkening",...b.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Level',
    required: true,
    placeholder: 'All levels',
...
}`,...y.parameters?.docs?.source},description:{story:"Focus — brand-blue border + glow ring",...y.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Level',
    placeholder: 'All levels',
    disabled: true,
...
}`,...f.parameters?.docs?.source},description:{story:"Disabled — no interaction, greyed-out",...f.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
...
}`,...E.parameters?.docs?.source},description:{story:"Optional marker",...E.parameters?.docs?.description}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  name: 'Label / No Label',
  args: {
    placeholder: 'Search…',
    id: 'input-nolabel'
  }
}`,...k.parameters?.docs?.source},description:{story:"No label — standalone input",...k.parameters?.docs?.description}}};L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
...
}`,...L.parameters?.docs?.source},description:{story:"Left icon — search",...L.parameters?.docs?.description}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
...
}`,...j.parameters?.docs?.source},description:{story:"Right icon — eye (e.g. show/hide password)",...j.parameters?.docs?.description}}};B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
...
}`,...B.parameters?.docs?.source},description:{story:"Both icons",...B.parameters?.docs?.description}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  name: 'Types / Password',
  render: () => {
...
}`,...q.parameters?.docs?.source},description:{story:"Email type",...q.parameters?.docs?.description}}};R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  name: 'Types / Number',
  args: {
    label: 'Quantity',
    type: 'number',
  ...
  render: () => {
    ...
    return <div style={{
      ...
      gap: 0
        ...
        fontSize: 12,
        marginTop: 4,
        color: over ? 'var(--text-error)' : 'var(--text-secondary)',
...
}`,...P.parameters?.docs?.source},description:{story:"Character counter",...P.parameters?.docs?.description}}};F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  name: 'All States',
  render: () => {
    const rows: Array<{
      label: string;
...
}`,...F.parameters?.docs?.source},description:{story:"Every state and variant at a glance",...F.parameters?.docs?.description}}};V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
...
}`,...M.parameters?.docs?.source},description:{story:"Verifies lock-icon password toggle works",...M.parameters?.docs?.description}}};const ge=["Default","Hover","Focus","Disabled","PlaceholderText","Error","ErrorHover","ErrorFocus","Required","Optional","NoLabel","WithLeftIcon","WithRightIcon","WithBothIcons","PasswordType","EmailType","NumberType","LiveValidation","CharacterCounter","AllStates","InteractionTest","DisabledInteractionTest","PasswordToggleTest"];export{F as AllStates,P as CharacterCounter,g as Default,f as Disabled,D as DisabledInteractionTest,q as EmailType,w as Error,T as ErrorFocus,S as ErrorHover,y as Focus,b as Hover,V as InteractionTest,A as LiveValidation,k as NoLabel,R as NumberType,E as Optional,M as PasswordToggleTest,C as PasswordType,x as PlaceholderText,I as Required,B as WithBothIcons,L as WithLeftIcon,j as WithRightIcon,ge as __namedExportsOrder,ve as default};
