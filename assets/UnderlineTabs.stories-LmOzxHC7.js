import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as S}from"./iframe-2IrQ87nu.js";import{c as o}from"./tokens-D4cFRLhh.js";import"./preload-helper-PPVm8Dsz.js";function D({value:n}){return e.jsx("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",flexShrink:0,width:16,height:16,borderRadius:999,background:o["bg-brand"],fontFamily:"'Fira Sans', sans-serif",fontSize:9,fontWeight:600,color:o["text-invert"],lineHeight:1},children:n})}function P({item:n,active:t,stretched:l,onClick:r}){const[a,v]=S.useState(!1),d=!!n.disabled,w=a&&!d,g=t||a&&t?o["text-brand"]:d?o["text-disabled"]:o["text-secondary"],T=d?"#ebeef0":t?o["bg-brand"]:o["border-primary"],x=!!n.icon,I=x&&(n.iconPosition??"left")==="left",C=x&&n.iconPosition==="right";return e.jsxs("button",{role:"tab","aria-selected":t,disabled:d,onClick:r,onMouseEnter:()=>v(!0),onMouseLeave:()=>v(!1),style:{display:"flex",flexDirection:"column",alignItems:"center",gap:1,flex:l?"1 0 0":void 0,background:"none",border:"none",padding:0,cursor:d?"not-allowed":"pointer",minWidth:0},children:[e.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:x||n.counter!=null?4:0,padding:"4px 16px",borderRadius:4,background:w?o["bg-secondary"]:"transparent",transition:"background 0.12s"},children:[I&&e.jsx("span",{style:{display:"inline-flex",width:20,height:20,color:g,flexShrink:0},children:n.icon}),e.jsx("span",{style:{fontFamily:"'Fira Sans', sans-serif",fontSize:14,fontWeight:600,color:g,lineHeight:"18px",whiteSpace:"nowrap",transition:"color 0.12s"},children:n.label}),n.counter!=null&&e.jsx(D,{value:n.counter}),C&&e.jsx("span",{style:{display:"inline-flex",width:20,height:20,color:g,flexShrink:0},children:n.icon})]}),e.jsx("div",{style:{height:2,width:"100%",borderRadius:1,background:T,transition:"background 0.12s",flexShrink:0}})]})}function y({tabs:n,activeId:t,onChange:l,stretched:r=!1}){return e.jsx("div",{role:"tablist",style:{display:"flex",alignItems:"stretch",height:29,overflow:"hidden",width:r?"100%":void 0},children:n.map(a=>e.jsx(P,{item:a,active:a.id===t,stretched:r,onClick:()=>!a.disabled&&l(a.id)},a.id))})}y.__docgenInfo={description:`Learnlight Design System — Underline Tabs
...
}`,...m.parameters?.docs?.source}}};const W=["Default","Stretched","WithCounter","WithDisabled","WithIcons","AllStates","NotificationsExample"];export{f as AllStates,c as Default,m as NotificationsExample,b as Stretched,u as WithCounter,p as WithDisabled,h as WithIcons,W as __namedExportsOrder,R as default};
