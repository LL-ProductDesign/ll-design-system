import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as M}from"./iframe-R0gxy-mM.js";import{h as Y,j as W,t as J,a as Q}from"./tokens-Ewy7nuVW.js";import{i as ee,I as te}from"./Icons-BQznmR0U.js";import"./preload-helper-PPVm8Dsz.js";const ne=J.find(t=>t.name===Q.find(n=>n.token==="button-text")?.primitive),ae=ne?.fontWeight??600,re=Object.fromEntries(Object.entries(W).map(([t,n])=>[t,Object.fromEntries(Object.entries(n).map(([s,a])=>[s,a.value]))])),se={l:{height:40,paddingX:8,fontSize:14,iconSize:16,gap:6},m:{height:32,paddingX:8,fontSize:13,iconSize:14,gap:5},s:{height:24,paddingX:8,fontSize:12,iconSize:12,gap:4}},E=t=>e.jsxs("svg",{width:t,height:t,viewBox:"0 0 16 16",fill:"currentColor","aria-hidden":!0,children:[e.jsx("rect",{x:"2",y:"4",width:"12",height:"1.5",rx:"0.75"}),e.jsx("rect",{x:"2",y:"7.25",width:"12",height:"1.5",rx:"0.75"}),e.jsx("rect",{x:"2",y:"10.5",width:"12",height:"1.5",rx:"0.75"})]});function i({variant:t="primary",size:n="m",content:s="default",isDisabled:a=!1,leftIcon:r=!1,rightIcon:c=!1,selectIconLeft:d,selectIconRight:q,text:P="Button",onClick:U,...X}){const[G,N]=M.useState(!1),o=re[t],l=se[n],$=a?"bgDisabled"in o?o.bgDisabled:o.bg:G?o.bgHover:o.bg,_=a&&"textDisabled"in o?o.textDisabled:o.text,K=t==="secondary"?`1.5px solid ${a?o.borderDisabled:o.border}`:"1.5px solid transparent",p=s==="icon_only",Z=p?l.height:void 0;return e.jsxs("button",{type:"button",disabled:a,onClick:U,onMouseEnter:()=>N(!0),onMouseLeave:()=>N(!1),style:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:l.gap,height:l.height,width:Z,paddingLeft:p?0:l.paddingX,paddingRight:p?0:l.paddingX,background:$,color:_,border:K,borderRadius:Y.interactive,fontSize:l.fontSize,fontFamily:"'Fira Sans', sans-serif",fontWeight:ae,lineHeight:1,cursor:a?"not-allowed":"pointer",transition:"background 0.15s, color 0.15s",whiteSpace:"nowrap",outline:"none",userSelect:"none"},...X,children:[!p&&r&&e.jsx("span",{style:{display:"flex",alignItems:"center",color:_},children:d??E(l.iconSize)}),p?d??E(l.iconSize):e.jsx("span",{children:P}),!p&&c&&e.jsx("span",{style:{display:"flex",alignItems:"center",color:_},children:q??E(l.iconSize)})]})}i.__docgenInfo={description:"Learnlight Design System — Button",methods:[],displayName:"LearnlightButton",props:{variant:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'txt' | 'txt_grey'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'txt'"},{name:"literal",value:"'txt_grey'"}]},description:`Visual style variant.
...
@default 'Button'`,defaultValue:{value:"'Button'",computed:!1}}},composes:["Omit"]};const{expect:F,fn:H,userEvent:O,within:oe}=__STORYBOOK_MODULE_TEST__,A=["none",...ee],ie={l:16,m:14,s:12};function V(t,n){return t&&t!=="none"?e.jsx(te,{name:t,size:n}):void 0}const ge={title:"Components/Button",component:i,parameters:{layout:"centered"},tags:["autodocs"],render:({leftIconName:t,rightIconName:n,size:s="m",...a})=>{const r=ie[s],c=V(t,r),d=V(n,r);return e.jsx(i,{...a,size:s,leftIcon:!!c,rightIcon:!!d,selectIconLeft:c,selectIconRight:d})},argTypes:{variant:{control:"select",options:["primary","secondary","txt","txt_grey"],description:"Visual style variant"},size:{control:"select",options:["l","m","s"],description:"Button size — l=40px, m=32px, s=24px"},content:{control:"select",options:["default","icon_only"],description:"Layout mode"},isDisabled:{control:"boolean"},leftIcon:{table:{disable:!0}},rightIcon:{table:{disable:!0}},selectIconLeft:{table:{disable:!0}},selectIconRight:{table:{disable:!0}},text:{control:"text"},onClick:{action:"clicked"},leftIconName:{control:"select",options:A,description:'Left icon — select an icon to enable, "none" to hide',table:{category:"Icons"}},rightIconName:{control:"select",options:A,description:'Right icon — select an icon to enable, "none" to hide',table:{category:"Icons"}}},args:{onClick:H(),leftIconName:"none",rightIconName:"none"}},m={args:{variant:"primary",size:"m",text:"Button"}},u={args:{variant:"primary",text:"Button"},play:async({canvasElement:t,args:n})=>{const a=oe(t).getByRole("button");await O.click(a),F(n.onClick).toHaveBeenCalledTimes(1),await O.tab(),await O.keyboard("{Enter}"),F(n.onClick).toHaveBeenCalledTimes(2)}},g={args:{variant:"secondary",text:"Button"}},x={name:"Text (Blue)",args:{variant:"txt",text:"Button"}},y={name:"Text (Grey)",args:{variant:"txt_grey",text:"Button"}},h={name:"Size / Large (40px)",args:{size:"l",text:"Large"}},f={name:"Size / Medium (32px)",args:{size:"m",text:"Medium"}},b={name:"Size / Small (24px)",args:{size:"s",text:"Small"}},v={name:"Size / All Sizes",render:t=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:16},children:[e.jsx(i,{...t,size:"l",text:"Large (40px)"}),e.jsx(i,{...t,size:"m",text:"Medium (32px)"}),e.jsx(i,{...t,size:"s",text:"Small (24px)"})]}),args:{variant:"primary"}},S={args:{isDisabled:!0,text:"Disabled"}},I={name:"Disabled / Secondary",args:{variant:"secondary",isDisabled:!0,text:"Disabled"}},z={name:"Disabled / Text",args:{variant:"txt",isDisabled:!0,text:"Disabled"}},T={name:"Icons / Left Icon",args:{leftIconName:"search",text:"With Icon"}},B={name:"Icons / Right Icon",args:{rightIconName:"arrow-right",text:"With Icon"}},j={name:"Icons / Both Icons",args:{leftIconName:"search",rightIconName:"arrow-right",text:"With Icons"}},k={name:"Icons / Icon Only",args:{leftIconName:"search",content:"icon_only"}},D={name:"Edge / Long Label",args:{text:"This is a very long button label that exceeds fifty characters",variant:"primary"}},L={name:"Edge / Single Character",args:{text:"A",variant:"secondary"}},w={name:"Edge / Inside Form",render:t=>e.jsxs("form",{onSubmit:n=>{n.preventDefault(),alert("Form submitted!")},style:{display:"flex",flexDirection:"column",gap:12,padding:24,border:"1px solid #e5e7eb",borderRadius:8,minWidth:280},children:[e.jsxs("label",{style:{fontSize:13,color:"#374151"},children:["Email",e.jsx("input",{type:"email",placeholder:"you@example.com",style:{display:"block",marginTop:4,width:"100%",padding:"6px 8px",border:"1px solid #d1d5db",borderRadius:4,fontSize:13,boxSizing:"border-box"}})]}),e.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[e.jsx(i,{...t,variant:"txt_grey",text:"Cancel"}),e.jsx(i,{...t,variant:"primary",text:"Submit"})]})]}),args:{onClick:H()}},le={bg:"Background",bgHover:"Background (hover)",bgDisabled:"Background (disabled)",text:"Text",textDisabled:"Text (disabled)",border:"Border",borderDisabled:"Border (disabled)"},R={name:"Token Usage",render:()=>{const t=Object.keys(W);return e.jsxs("div",{style:{fontFamily:"'Fira Sans', sans-serif",maxWidth:860,padding:"8px 0"},children:[e.jsx("p",{style:{margin:"0 0 28px",fontSize:12,color:"#5d7682"},children:"Each variant's colour slots mapped to their design token name."}),t.map(n=>{const s=W[n];return e.jsxs("div",{style:{marginBottom:36},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,marginBottom:14},children:[e.jsx("h3",{style:{margin:0,fontSize:13,fontWeight:700,color:"#092f42",textTransform:"uppercase",letterSpacing:"0.06em",minWidth:80},children:n}),e.jsx(i,{variant:n,size:"m",text:"Preview"}),e.jsx(i,{variant:n,size:"m",text:"Disabled",isDisabled:!0})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"160px 140px 40px",gap:"6px 16px",alignItems:"center"},children:[["Slot","Token",""].map(a=>e.jsx("div",{style:{fontSize:10,fontWeight:700,color:"#9ca3af",textTransform:"uppercase",letterSpacing:"0.06em",paddingBottom:4,borderBottom:"1px solid #ebeef0"},children:a},a)),Object.entries(s).map(([a,r])=>{const c=r.value==="transparent"||r.value==="#0000000a";return e.jsxs(M.Fragment,{children:[e.jsx("div",{style:{fontSize:12,color:"#5d7682"},children:le[a]??a}),e.jsx("div",{style:{fontSize:11,fontFamily:"monospace",color:"#092f42",background:"#f5f6f7",padding:"2px 6px",borderRadius:4},children:r.token}),e.jsx("div",{title:r.value,style:{width:28,height:18,borderRadius:4,background:c?"repeating-conic-gradient(#dfe4e6 0% 25%, #fff 0% 50%) 0 0 / 8px 8px":r.value,border:"1px solid rgba(0,0,0,0.1)"}})]},a)})]})]},n)})]})}},C={name:"All Variants",render:()=>{const t=["primary","secondary","txt","txt_grey"],n=["l","m","s"],s=[{label:"Default",props:{}},{label:"Left icon",props:{leftIcon:!0}},{label:"Right icon",props:{rightIcon:!0}},{label:"Both icons",props:{leftIcon:!0,rightIcon:!0}},{label:"Icon only",props:{content:"icon_only"}},{label:"Disabled",props:{isDisabled:!0}}];return e.jsx("div",{style:{fontFamily:"sans-serif",overflowX:"auto"},children:t.map(a=>e.jsxs("div",{style:{marginBottom:40},children:[e.jsx("h3",{style:{margin:"0 0 12px",fontSize:13,color:"#6b7280",textTransform:"uppercase",letterSpacing:"0.05em"},children:a}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, auto)",gap:"12px 24px",alignItems:"center",justifyItems:"start"},children:[n.map(r=>e.jsxs("div",{style:{fontSize:11,color:"#9ca3af",textAlign:"center"},children:[r.toUpperCase()," — ",r==="l"?"40px":r==="m"?"32px":"24px"]},r)),s.map(({label:r,props:c})=>n.map(d=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-start",gap:4},children:[e.jsx(i,{variant:a,size:d,text:"Button",...c}),e.jsx("span",{style:{fontSize:10,color:"#9ca3af"},children:r})]},`${r}-${d}`)))]})]},a))})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'primary',
    size: 'm',
    text: 'Button'
...
}`,...y.parameters?.docs?.source},description:{story:"Text-only with grey label — minimal-emphasis action",...y.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: 'Size / Large (40px)',
  args: {
    size: 'l',
    text: 'Large'
  }
}`,...h.parameters?.docs?.source},description:{story:"Large — 40px height",...h.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: 'Size / Medium (32px)',
  args: {
    size: 'm',
    text: 'Medium'
  }
}`,...f.parameters?.docs?.source},description:{story:"Medium — 32px height",...f.parameters?.docs?.description}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  name: 'Size / Small (24px)',
  args: {
    size: 's',
    text: 'Small'
  }
}`,...b.parameters?.docs?.source},description:{story:"Small — 24px height",...b.parameters?.docs?.description}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  name: 'Size / All Sizes',
...
}`,...v.parameters?.docs?.source},description:{story:"All three sizes side by side",...v.parameters?.docs?.description}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
    isDisabled: true,
    text: 'Disabled'
  }
...
}`,...B.parameters?.docs?.source},description:{story:"Right icon + label",...B.parameters?.docs?.description}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
...
}`,...j.parameters?.docs?.source},description:{story:"Both icons flanking the label",...j.parameters?.docs?.description}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  name: 'Icons / Icon Only',
  args: {
    leftIconName: 'search',
    content: 'icon_only'
  }
}`,...k.parameters?.docs?.source},description:{story:"Icon-only — no label",...k.parameters?.docs?.description}}};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
...
}`,...C.parameters?.docs?.source},description:{story:"Every variant × size × state at a glance",...C.parameters?.docs?.description}}};const xe=["Default","Primary","Secondary","TextBlue","TextGrey","SizeLarge","SizeMedium","SizeSmall","AllSizes","Disabled","DisabledSecondary","DisabledText","WithLeftIcon","WithRightIcon","WithBothIcons","IconOnly","LongText","ShortText","InsideForm","TokenUsage","AllVariants"];export{v as AllSizes,C as AllVariants,m as Default,S as Disabled,I as DisabledSecondary,z as DisabledText,k as IconOnly,w as InsideForm,D as LongText,u as Primary,g as Secondary,L as ShortText,h as SizeLarge,f as SizeMedium,b as SizeSmall,x as TextBlue,y as TextGrey,R as TokenUsage,j as WithBothIcons,T as WithLeftIcon,B as WithRightIcon,xe as __namedExportsOrder,ge as default};
